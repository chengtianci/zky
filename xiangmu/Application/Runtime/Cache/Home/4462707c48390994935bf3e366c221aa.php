		...
		<div id='main'>
			<div class="contain">
				<div id='left'>
					<div id='book'>
						<h2>　仪器预约系统</h2>
							<?php if(is_array($data0)): $i = 0; $__LIST__ = $data0;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><i><a href="<?php echo ($vo["address"]); ?>">> <?php echo ($vo["name"]); ?></a></i><?php endforeach; endif; else: echo "" ;endif; ?>
						<!-- <br />
			...
			<div id='right'>
				...
				<div id="rdown">
					<div class="rdown-left" style="width:45%;padding:10px;float:left;">
						<div class="hena"><font><b>&nbsp;&nbsp;最新通知</b><i>NOTICE</i></font><a href="/zky/zky/index.php/Home/Inform/news.html"></a></div>
						<div id="list">
					...
					<div class="rdown-right" style="width:45%;padding:10px;float:right;margin-left:10px;">
						<div class="hena"><font><b>&nbsp;&nbsp;文档下载</b><i>FILE</i></font><a href="/zky/zky/index.php/Home/File/document.html"></a></div>
						<div id="list">
