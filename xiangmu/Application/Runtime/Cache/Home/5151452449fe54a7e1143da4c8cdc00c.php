...
<html>
	...
	<body>
		...
		<div id='header'>
			<div class="contain" >
				<img src="/zky/zky/Public/Pic/top.jpg" alt=""  />
			</div>
		</div>
		<div id='navi'>
			<div class="contain">
			...
			<div class="contain">
				<div id="showlist">
					...
					<h2>最新消息</h2>
						...
						<a href="/zky/zky/index.php/Home/Index/main">首页</a><span>></span><a href="/zky/zky/index.php/Home/Inform/news">新闻通知</a><span>> 详细介绍 </span></div>
					</div>
					<div id="list" style="margin-left: 5%; margin-right: 4.5%;">
						<br>
						<h3><center><?php echo ($data["title"]); ?></center></h3>
						<br>
						<p><?php echo ($data["content"]); ?></p>
						<br />
						<p style = "text-align: right;"><?php echo ($data["date"]); ?></p>
					</div>
				</div>
			</div>
		</div>
