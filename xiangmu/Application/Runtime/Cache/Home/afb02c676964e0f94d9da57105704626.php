...
<html>
	<head>
		...
		<link rel="stylesheet" type='text/css' href="/zky/zky/Public/Css/communication.css" />
    ...
    <!-- 结束注册窗口 -->
		...
		<div id='main'>
			<div class="contain">
				<div id="main_navi">
				<h2 >留言区</h2>
						<div class="main_navi_header"><img src="/zky/zky/Public/Pic/home.png" alt="" />当前位置：<a href="/zky/zky/index.php/Home/Index/main">首页</a><span>>讨论区 </span></div>
						   	
				</div>
				<div id="show">
					<?php if(($user) == "0"): ?><a href="/zky/zky/index.php/Home/Message/add_message" id="add_me">添加留言</a><br /><br />
								<?php else: ?> 
									<?php if(($user) == ""): ?><p>
							...
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div id="point"></div><p><?php echo ($vo["title"]); ?><a href="/zky/zky/index.php/Home/Message/do_see/id/<?php echo ($vo["id"]); ?>">查看详情</a> <span id='time'> <?php echo ($vo["date"]); ?></span></p><?php endforeach; endif; else: echo "" ;endif; ?>
