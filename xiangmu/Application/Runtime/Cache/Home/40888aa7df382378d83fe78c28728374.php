...
<html>
	<head>
		...
		<link rel="stylesheet" href="/zky/zky/Public/Css/about_us.css" />
	...
	<body>
		...
		<div id='main'>
			<div class="contain">
				<div id="main_navi"><h2>　植科院公共平台目前的组织管理结构如下</h2>
						<div class="main_navi_header">
						<img src="/zky/zky/Public/Pic/home.png" alt="" />当前位置：<a href="/zky/zky/index.php/Home/Index/main">首页</a><span>--->关于我们</span>
						</div>
				</div>
				<ul id='show'>
						
						<?php if(is_array($data0)): $i = 0; $__LIST__ = $data0;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><img src="/zky/zky/Public/Pic/na.png" alt="" />　<span class="na"><?php echo ($vo["position"]); ?>  <?php echo ($vo["name"]); ?></span></li>
							<li><img src="/zky/zky/Public/Pic/job.png" alt="" />　<span class="inf"><?php echo ($vo["responsibility"]); ?>	<?php echo ($vo["responsible"]); ?></span></li>
							<br /><?php endforeach; endif; else: echo "" ;endif; ?><br>
						<?php if(is_array($data1)): $i = 0; $__LIST__ = $data1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class='add'><img src="/zky/zky/Public/Pic/address.png" alt="" />　<?php echo ($vo["adress"]); ?>:<?php echo ($vo["addressname"]); ?></li>
							<li class='add'><img src="/zky/zky/Public/Pic/person.png" alt="" />　<?php echo ($vo["people"]); ?>：<?php echo ($vo["peoplename"]); ?></li>
							<li class='add'><img src="/zky/zky/Public/Pic/zip_code.png" alt="" />　<?php echo ($vo["post"]); ?>：<?php echo ($vo["postid"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
				<br />
			</div>
		</div>
