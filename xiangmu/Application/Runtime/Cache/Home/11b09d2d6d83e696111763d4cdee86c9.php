...
<html>
	<head>
		...
		<link rel="stylesheet" type='text/css' href="/zky/zky/Public/Css/regulation.css" />
	...
	<body>
		...
		<div id='main'>
			<div class="contain">
				<div id="main_navi">
						<h2 >规章制度</h2>
						<div class="main_navi_header"><img src="/zky/zky/Public/Pic/home.png" alt="" />当前位置 ：<a href="/zky/zky/index.php/Home/Index/main">首页 </a> <span> > 规章制度</span></div>
				</div>
				<div id="show">
					<table >
