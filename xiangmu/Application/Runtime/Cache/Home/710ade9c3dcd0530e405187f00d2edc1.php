...
<html>
	<head>
		...
		<link rel="stylesheet" type='text/css' href="/zky/zky/Public/Css/showclass.css" />
	...
	<body>
		...
		<div id='main' style="height:915px; ">
			<div class="contain" style="height:915px; ">
				<div id="main_navi"><h2><?php echo ($class1); ?> </h2>
						<div class="main_navi_header" ><img src="/zky/zky/Public/Pic/home.png" alt="" />
									当前位置：
									<a href="/zky/zky/index.php/Home/Index/main">首页</a>
									<span>> </span>
									<a href="/zky/zky/index.php/Home/Equipment/equipment"> 仪器介绍</a> 
									<span> ><?php echo ($class1); ?> </span>
						</div>
