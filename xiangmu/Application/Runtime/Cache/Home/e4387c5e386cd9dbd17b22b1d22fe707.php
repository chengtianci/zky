...
<html>
	<head>
		...
		<link rel="stylesheet" type='text/css' href="/zky/zky/Public/Css/documents.css" />
	...
	<body>
		...
		<div id='main'>
			<div class="contain">
				<div id="main_navi">
					<h2>相关文件下载：</h2>
					<div class="main_navi_header"><img src="/zky/zky/Public/Pic/home.png" alt="" />当前位置：<a href="/zky/zky/index.php/Home/Index/main">首页</a><span>>文档下载</span></div>
				</div>
				<div id="d_list">
					<ul>
						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
								<a href="/zky/zky/Uploads/<?php echo ($vo["address"]); ?>" target="_blank" >
