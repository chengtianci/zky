...
<body>
    ...
    <a href="/zky/index.php/Admin/Message/studenttdetail"><?php echo (session('username')); ?></a> <br><br>
                    修改详细信息
                    <input type="text" name = "id" value = "<?php echo ($data['id']); ?>" id = "id" hidden/>
                    概　述：<input type="text" name="title" id = "title"  width="200px" value="<?php echo ($data['title']); ?>" />
                <!-- 初始化内容 -->
                <script id='container' name='content' type="text/plain" style="height:500px; width:96%"><?php echo ($data['content']); ?></script>
                ...
                <script type="text/javascript">
                    $(function(){
                        ...
                        $('#saveContent').click(function(){
                            var html = ue.getContent();
                            var link = $("#id").val();
                            var resulturl = '/zky/index.php/Admin/Equipment/doUpdateManagement/id/'+ link;
                            var param = {
                                title: $("#title").val(),
                                content: html
                            };
